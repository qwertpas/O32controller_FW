...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC_IN9
    */
    HAL_GPIO_DeInit(GPIOA, OP_V_O_Pin|OP_W_O_Pin|GPIO_PIN_4);

    HAL_GPIO_DeInit(OP_U_O_GPIO_Port, OP_U_O_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA12     ------> TIM1_ETR
    */
    HAL_GPIO_DeInit(GPIOB, OC_COMP_INT_Pin|LSU_Pin|LSV_Pin|GPIO_PIN_15);

    HAL_GPIO_DeInit(GPIOA, HSU_Pin|HSV_Pin|GPIO_PIN_10|OC_COMP_INT2_Pin);
